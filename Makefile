...
OBJS = src/main.o src/logging.o src/tspconf.o src/tsp_fileparser.o src/tsp_solvers_dummybbf.o src/tsp_solvers_dummybb.o src/tsp.o src/tspplot.o src/tsp_solvers_dummy.o src/tsp_solvers_flow1.o src/tsp_solvers_flow1lazy.o src/tsp_solvers_mtz.o src/tsp_solvers_mtzlazy.o src/tsp_solvers_random.o src/tsp_solvers_utils.o
HEADERS = ./include/*.h 
EXE = $(BUILD_DIR)
all: $(EXE) 
setting = -1   
