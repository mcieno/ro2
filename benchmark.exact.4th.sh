...
bmfile_nodes="$bmsig.th4.nodes.csv"
bmfile_times="$bmsig.th4.times.csv"

bmfile_nodes_png="$bmsig.th4.nodes.png"
bmfile_times_png="$bmsig.th4.times.png"

mkdir -p $bmdir || exit 1

echo "[*] Saving benchmark to $bmsig.th4.[nodes|times].csv"
