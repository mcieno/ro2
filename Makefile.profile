...
COPTPROF      = -g3 -O0 -m64 -pg -Wall -Werror --pedantic -fstack-protector-all -no-pie -fno-PIE
CFLAGSPERF    = $(COPTPERF)  -I$(LOCAL_INCDIR)  -I$(CPLEXINCDIR)
CFLAGSDEBG    = $(COPTDEBG)  -I$(LOCAL_INCDIR)  -I$(CPLEXINCDIR)
CFLAGSPROF    = $(COPTPROF)  -I$(LOCAL_INCDIR)  -I$(CPLEXINCDIR)
...
profile:
	-@echo -e "$(FANCYLOG) Building all for profiling"
	mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGSPROF) $(CLNDIRS) -o $(BUILD_DIR)/tsp-profile $(TSP_SRC_FILES) $(CLNFLAGS)
...
.PHONY: debug perf clean config profile
